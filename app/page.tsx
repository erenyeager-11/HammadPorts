...
const EMAIL = "hammadpvt.2@gmail.com";
...
const L = (s: string): Localised => ({ es: s, en: s });
...
const projects: Project[] = [
  {
    num: "01",
    name: L("Mind Game"),
    stack: ["JavaScript", "HTML/CSS", "Game Logic", "Vercel"],
    desc: L("Brain-twisting mini-games for the minutes between grind sessions. Keeps the mind sharp and reflexes faster."),
    details: L("A collection of quick, brain-twisting mini-games built for the minutes between study sessions. Game logic runs in the browser with JavaScript, HTML and CSS, and the project is deployed live on Vercel."),
    url: "https://mind-games-seven.vercel.app/",
    media: ["/projects/mind-game/cover.svg"],
    highlights: ["javascript", "html5", "css", "vercel"],
    badge: L("Live on Vercel"),
    align: "left",
    section: "project1",
  },
  {
    num: "02",
    name: L("Study Tracker"),
    stack: ["Dashboard", "Productivity", "JavaScript", "Vercel"],
    desc: L("A focus dashboard. Track sessions, lock in — no distractions, no excuses."),
    details: L("A focus dashboard for tracking study sessions. Built to remove distractions and keep you locked in, with a clean productivity-first interface, deployed live on Vercel."),
    url: "https://focus-sigma-ruby.vercel.app/",
    media: ["/projects/study-tracker/cover.svg"],
    highlights: ["javascript", "html5", "css", "vercel"],
    badge: L("Live on Vercel"),
    align: "right",
    section: "project2",
  },
  {
    num: "03",
    name: L("Chess"),
    stack: ["JavaScript", "Game Engine", "Chess Logic", "Vercel"],
    desc: L("Fully playable chess with move validation, clean UI and smooth animations."),
    details: L("A fully playable chess game with move validation, a clean interface and smooth animations. The chess logic and game engine are written in JavaScript and deployed live."),
    url: "https://chess-hub-rosy.vercel.app",
    media: ["/projects/chess/cover.svg"],
  ...
  {
    num: "04",
    name: L("Proposal Letters"),
    stack: ["Templates", "Design", "HTML/CSS", "Vercel"],
    desc: L("Beautiful letter templates for moments that matter most."),
    details: L("A set of beautifully designed letter templates for the moments that matter most, focused on typography, layout and mood. Deployed live on Vercel."),
    url: "https://for-you-gray-two.vercel.app/",
    media: ["/projects/proposal-letters/cover.svg"],
    highlights: ["html5", "css", "figma", "vercel"],
    badge: L("Live on Vercel"),
    align: "right",
    section: "project4",
  },
  {
    num: "05",
    name: L("Link Hub"),
    stack: ["Link-in-bio", "HTML/CSS", "Vercel"],
    desc: L("Clean personal link-in-bio. Everything in one place, nothing in the way."),
    details: L("A clean personal link-in-bio page: everything in one place and nothing in the way. Simple HTML and CSS, deployed live on Vercel."),
    url: "https://lakshya-og.vercel.app/",
    media: ["/projects/link-hub/cover.svg"],
    highlights: ["html5", "css", "vercel"],
    badge: L("Live on Vercel"),
    align: "left",
    section: "project5",
  },
  {
    num: "06",
    name: L("Al-Qur'an"),
    stack: ["React", "Typography", "UI Design", "Vercel"],
    desc: L("Clean digital Quran app — beautiful typography, a reading experience that honours the text."),
    details: L("A clean digital Quran app with a reading experience that honours the text, built around beautiful typography and careful UI design. Made with React and deployed live on Vercel."),
    url: "https://al-qur-an-three.vercel.app/",
    media: ["/projects/al-quran/cover.svg"],
    highlights: ["react", "javascript", "css", "vercel"],
    badge: L("Live on Vercel"),
    align: "right",
    section: "project6",
  },
...
const experiences: Array<{
...
}> = [
  {
    ...
    company: "Independent",
    period: L("2+ years"),
    location: L("New Delhi, India"),
    summary: L("Building clean, animated interfaces that refuse to be boring. Web apps and UI experiments, shipped because they needed to exist."),
    bullets: [
      L("6 projects shipped, every one of them live on Vercel."),
      L("Browser game logic: Mind Game and a fully playable Chess with move validation."),
      L("Productivity tooling: a Study Tracker focus dashboard."),
      L("React and typography-first UI: a digital Al-Qur'an reader."),
    ],
    stack: ["HTML/CSS", "JavaScript", "React", "Python", "Git", "Vercel"],
  },
];
        ...
        <main className="relative z-10 pointer-events-none">
          ...
          >
            ...
            <div className="mt-2 md:mt-20">
              ...
              <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-[6.5rem] font-bold tracking-[-0.03em] text-ice-50 leading-[0.92] whitespace-nowrap">
                <HeroWord text="Mohammad" delay={120} />
                <br />
                <HeroWord text="Hammad" delay={260} className="text-ice-400" />
              </h1>
              <p
              ...
              >
                <button
                  ...
                  onClick={() =>
                    document
                      .querySelector<HTMLElement>('[data-kb-section="project1"]')
          ...
          <section
            ...
            className="relative md:min-h-[200vh] pt-24 px-6 pb-6 sm:p-10 md:p-14"
          >
